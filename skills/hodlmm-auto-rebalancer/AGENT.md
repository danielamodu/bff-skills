...
description: "Executes liquidity rebalancing strictly when bin drift exceeds 10 bins, enforcing max gas caps."
---
...
4. **Contract Integrity**: Only interacts with the validated Bitflow DLMM Router address.
